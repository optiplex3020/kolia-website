const archives = [
  { code: "07", titre: "Mémoire de braise", statut: "Épuisé", note: "Septembre" },
  { code: "06", titre: "Pluie sur Ouidah", statut: "Épuisé", note: "Juin" },
  { code: "05", titre: "Hiver #3", statut: "Archive", note: "Février" },
];
  ...
  return (
    <section className="mx-auto flex min-h-[calc(100vh-80px)] max-w-3xl flex-col gap-10 px-6 py-24">
      ...
      <p className="text-sm text-[var(--color-text-secondary)]">
        Les rituels passés sont conservés sous scellés. Les membres peuvent demander un accès
        ponctuel par lettre.
      </p>
